var RecipesBox = React.createClass({
    ...
    render: function () {
      return (
          <div>
            <BuildMessageList buildMessageRemoved={this.buildMessageRemoved} buildAnnouncements={this.state.buildAnnouncements}/>
            <RecipesTable api_url={this.props.api_url}  announceBuildCallback={this.announceBuild} recipes={this.state.recipes}/>
          </div>
      );
    }
});
    ...
    render: function () {
      return (
        <tr>
            ...
            <td><button type="submit" onClick={this.handleRecipeTrigger} className="btn btn-primary">Trigger</button></td>
        </tr>
      );
    }
  });
    ...
    render: function () {
        return (
            <div className="alert alert-info alert-dismissable">
                <button type="button" className="close" onClick={this.props.buildMessageRemoved} aria-hidden="true">&times;</button>
                <i className="fa fa-info-circle"></i>  Build Startedfor Repository:
